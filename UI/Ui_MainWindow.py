...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.updateButton.setGeometry(QtCore.QRect(550, 710, 113, 32))
        ...
        self.MeanFilterButton.setGeometry(QtCore.QRect(20, 710, 113, 32))
        ...
        self.dashedLabel.setGeometry(QtCore.QRect(120, 644, 16, 16))
        ...
        self.stopLineEdit.setGeometry(QtCore.QRect(140, 644, 91, 21))
        self.stopLineEdit.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.stopLineEdit.setObjectName("stopLineEdit")
        self.startDeleteLineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.startDeleteLineEdit.setGeometry(QtCore.QRect(20, 674, 91, 21))
        self.startDeleteLineEdit.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.startDeleteLineEdit.setObjectName("startDeleteLineEdit")
        self.startDeleteLineEdit_2 = QtWidgets.QLineEdit(self.centralwidget)
        self.startDeleteLineEdit_2.setGeometry(QtCore.QRect(140, 674, 91, 21))
        self.startDeleteLineEdit_2.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.startDeleteLineEdit_2.setObjectName("startDeleteLineEdit_2")
        self.dashedLabel_2 = QtWidgets.QLabel(self.centralwidget)
        self.dashedLabel_2.setGeometry(QtCore.QRect(120, 674, 16, 16))
        self.dashedLabel_2.setAlignment(QtCore.Qt.AlignCenter)
        self.dashedLabel_2.setObjectName("dashedLabel_2")
        self.FrameZeroButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.FrameZeroButton_2.setGeometry(QtCore.QRect(240, 670, 113, 32))
        self.FrameZeroButton_2.setObjectName("FrameZeroButton_2")
        self.undoButton = QtWidgets.QPushButton(self.centralwidget)
        self.undoButton.setGeometry(QtCore.QRect(550, 680, 113, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dashedLabel_2.setText(_translate("MainWindow", "-"))
        self.FrameZeroButton_2.setText(_translate("MainWindow", "Delete Frame"))
